...
/* ---- Real-food benefit icons ---- */
export const BoltIcon = (p) => (
  <Svg {...p}><path d="M13 2 4.5 13.5a.7.7 0 0 0 .56 1.12H11l-1 7.38 8.5-11.5a.7.7 0 0 0-.56-1.12H12Z" /></Svg>
);
export const ShieldIcon = (p) => (
  <Svg {...p}>
    <path d="M12 2.5 4.5 5.5v6c0 4.6 3.2 7.9 7.5 9.5 4.3-1.6 7.5-4.9 7.5-9.5v-6Z" />
...
export const WavesIcon = (p) => (
  <Svg {...p}>
    <path d="M2 7c1.5 0 1.5 1.5 3 1.5S8.5 7 10 7s1.5 1.5 3 1.5S16.5 7 18 7s1.5 1.5 3 1.5" />
    <path d="M2 12c1.5 0 1.5 1.5 3 1.5S8.5 12 10 12s1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5" />
    <path d="M2 17c1.5 0 1.5 1.5 3 1.5S8.5 17 10 17s1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5" />
  </Svg>
);
export const BoneIcon = (p) => (
  <Svg {...p}>
    <path d="M17 10c1.5 0 3-1 3-3a2.5 2.5 0 0 0-4.6-1.4A2.5 2.5 0 0 0 11 7c0 .7.3 1.3.7 1.8L8.8 11.7C8.3 11.3 7.7 11 7 11a2.5 2.5 0 0 0-2.4 3.4A2.5 2.5 0 0 0 7 19c2 0 3-1.5 3-3 0-.7-.3-1.3-.7-1.8l2.9-2.9c.5.4 1.1.7 1.8.7Z" />
  </Svg>
);
